...
const rowData = [
    {
        id: 1,
        noti_senderid: 'Index Option Call Script : {{1}} Buy@ : {{2}} Target 1: {{3}} Target 2: {{4}} Stop-loss .{{5}} Research SEBI RA Number : INH000000000',
        noti_mobilenumber: 'Jensen',
        noti_message: 'carolinejensen@zidant.com',
        noti_datetime: '2004-05-28',
        noti_status: 'true',
        noti_errorid: '39',
    },
];

const col = ['id', 'Notification ID', 'Mobile ID', 'Message', 'Datetime', 'Status', 'Error'];
...
export default function ViewRecommendation() {
    ...
    const header = ['id', 'Notification ID', 'Mobile ID', 'Message', 'Datetime', 'Status', 'Error'];
            ...
            <div className="panel flex-1 overflow-x-hidden h-full">
                <div className="flex md:items-center justify-between md:flex-row flex-col mb-4.5 gap-5">
                    ...
                    <div className="flex items-center flex-wrap">
                        <NavLink to="/analyst/saleservice" className="btn btn-outline-primary m-1">Back</NavLink>
                    </div>
                </div>
                <div className="datatables">
                    <DataTable
                        ...
                        columns={[
                            ...
                            { accessor: 'noti_senderid', title: 'Recommendation Message', sortable: true },
