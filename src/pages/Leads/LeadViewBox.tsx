...
export default function LeadViewBox({ showLeadViewDrawer, setLeadViewShowDrawer }: any) {
                ...
                <div className="flex flex-col h-screen overflow-hidden">
                    <div className="w-full text-center">
                        <div className="p-1 flex sm:flex-row flex-col w-full sm:items-center gap-4">
                            ...
                            {/* Lead Description */}
                            <button className='btn btn-outline-primary mr-[15px] btn-sm' onClick={() => setModalLeadDescription(true)}>Status History</button>
